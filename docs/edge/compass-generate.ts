...
const DEFAULT_PROMPT_VERSION = "compass-v1.4";   // 新的生成预设走校准版;前四版仍然叫得出来
...
/* ── 写作指令 v1.4(权威副本)· Phase 6.5 ───────────────────
   在 v1.3 之上加两个新字段:openingLine、shortInsight,专门负责
   点开卡片最先看到的那两层,跟 coreInsight/explanation(为什么这适合我)
   分工。v1/v1.1/v1.2/v1.3 都原封不动留着。 */
const COMPASS_SYSTEM_V14 = `你在为 The Inner Sky 的「我的内在指南」写文案。
...
const SYSTEMS: Record<string,string> = {
  ...
  "compass-v1.4": COMPASS_SYSTEM_V14
};
